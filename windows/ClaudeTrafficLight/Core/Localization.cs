    ...
    string LocaleId)
{
    ...
    public static readonly L10n English = new(
        ...
        "Active sessions", "Click a session to jump to it", "en");
    ...
    public static readonly Dictionary<string, L10n> Tables = new()
    {
        ...
        ["tr"] = new(
            ...
            "Aktif oturumlar", "Gitmek için bir oturuma tıkla", "tr"),
        ["es"] = new(
            ...
            "Sesiones activas", "Haz clic en una sesión para abrirla", "es"),
        ["de"] = new(
            ...
            "Aktive Sitzungen", "Sitzung anklicken, um zu ihr zu springen", "de"),
        ["fr"] = new(
            ...
            "Sessions actives", "Cliquez sur une session pour y accéder", "fr"),
        ["it"] = new(
            ...
            "Sessioni attive", "Clicca una sessione per aprirla", "it"),
        ["pt"] = new(
            ...
            "Sessões ativas", "Clique em uma sessão para abri-la", "pt"),
        ["ru"] = new(
            ...
            "Активные сессии", "Нажмите на сессию, чтобы открыть", "ru"),
        ["ja"] = new(
            "作業中…", "質問中", "完了",
